...
<?
	if ( !is_blank( $f_return ) ) {
		echo '<input type="hidden" name="return" value="<?php echo string_html_specialchars( $f_return ) ?>" />';
	}
...
<div class="logon_form">
	<?php if( ON == config_get( 'login_title_visible' ) ) { ?>
	<h3 class="blue-title">
	...
	<div class="form-group">
		...
		<input class="form-control" id="username" type="text" name="username" size="32" maxlength="<?php echo DB_FIELD_SIZE_USERNAME;?>" value="<?php echo string_attribute( $f_username ); ?>" />
	</div>
	...
	<div class="form-group">
		...
		<input class="form-control" id="password" type="password" name="password" size="32" maxlength="<?php echo auth_get_password_max_size(); ?>" />
	</div>
	...
	<div class="form-group">
		...
		<input class="btn btn-default btn-right" style="padding: 5px 12px" type="submit" class="button" value="<?php echo lang_get( 'login_button' ) ?>" />
	</div>
</div>
